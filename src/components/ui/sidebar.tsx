  ...
  (
    ...
    return (
        <aside
          ref={ref}
          className={cn(
            "group hidden md:flex flex-col text-sidebar-foreground bg-sidebar transition-all duration-300 ease-in-out",
...
>(({ className, ...props }, ref) => {
  return (
    <main
      ref={ref}
      className={cn(
        "flex-1 flex flex-col bg-background min-h-screen",
        className
      )}
      {...props}
    />
